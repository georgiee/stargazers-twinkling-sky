...
function createSky(_a) {
    ...
    for (var i = 0; i < count; i++) {
        ...
        var star = createStar(__assign({ color: color, size: sizeSkyStar }, coordinates, { index: i }));
        svg.appendChild(star);
    }
}
function createStar(_a) {
    var size = _a.size, color = _a.color, x = _a.x, y = _a.y, index = _a.index;
    ...
    var parallaxGroup = createSVGElement('g');
